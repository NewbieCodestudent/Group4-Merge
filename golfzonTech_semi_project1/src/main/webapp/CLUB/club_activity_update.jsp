...
<body>
    ...
    <div id="container">
        ...
        <!-- update 영역 -->
        <form action="club_activity_updateOK.do?club_id=${activity_info.club_name}" method="post" enctype="multipart/form-data" name="submit_info" onsubmit="return checkValue()">
    ...
    <script>
        ...
        function delete_action() {
            ...
            if(msg == true) {
                location.href = "club_activity_deleteOK.do?act_id=${param.act_id}&club_name=${param.club_name}&club_id=${param.club_id}";
            } else {
                return false;
            }
        }
