...
<body>
    ...
    <a id="event_3" href="event_selectOne.do?img_link=event_3.jpg&event_name=Golf_Event">
	    <img  src="CSS/AD/event_3.jpg" alt="AD">
    </a>
    <a id="event_4" href="event_selectOne.do?img_link=event_4.jpg&event_name=Golf_Event">
	    <img  src="CSS/AD/event_4.jpg" alt="AD">
    </a>
    <script>
    	/* 배너 출력 함수 */
        const ad_number = Math.floor(Math.random() * 5);
