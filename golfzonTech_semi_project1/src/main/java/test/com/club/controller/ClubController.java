...
public class ClubController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (sPath.equals("/club_insert.do")) {
			...
			request.getRequestDispatcher("HTML/club.jsp").forward(request, response);
			...
			request.getRequestDispatcher("HTML/clubSelect.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (sPath.equals("/club_insertOK.do")) {
			...
			String dir_path = "C:\\Users\\JS\\Desktop\\project_1\\Group4-Back-end-Public\\golfzonTech_semi_project1\\src\\main\\webapp\\IMG\\CLUB";
