...
//   private String member_id; //회원 아이디
   ...
   public ClubVO(long club_id, String club_leader, String club_name, String club_desc, String gender, String age,
         String location, Date cdate, int close, String club_img, long cm_id, String member_id, int qualified,
         int status, Date cmdate, int cmtype, String name, String m_gender, Date birthday, String m_location,
         String img_name, int m_age) {
      super();
