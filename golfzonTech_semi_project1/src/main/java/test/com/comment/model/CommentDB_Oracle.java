...
public interface CommentDB_Oracle {
	...
	String SQL_COMMENT_INSERT = "INSERT INTO CMT (COMMENT_ID,BOARD_ID,COMMENTER,CONTENT,CDATE)VALUES(SEQ_CMT.nextval,?,?,?, SYSDATE)";
	String SQL_COMMENT_DELETE_ONE = "DELETE FROM CMT WHERE COMMENT_ID = ?";
	String SQL_COMMENT_DELETE_ALL = "DELETE FROM CMT WHERE BOARD_ID = ?";
